...
const wait2 = (time, cancel = Promise.reject()) =>
...
/*
Promise.all only resolves when all Promises in the array passed in are resolved, 
and returns the array of resolved Promises. If any Promise inside the iterator rejects,
Promise.all rejects.
*/
...
const fail2 = (num1) =>
  new Promise((resolve, reject) =>
    setTimeout(() => reject(new Error("Being late is never a good habit")), 100)
  );
...
It doesn't reject unless all Promises in the iterator are rejected.
*/
